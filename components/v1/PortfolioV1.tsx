...
export function PortfolioV1({ isDarkMode, setIsDarkMode, onSelectVariant }: PortfolioV1Props) {
      ...
      <header className="fixed top-0 left-0 right-0 z-50 glass-panel border-b border-slate-200/80 dark:border-slate-800/80">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="hidden md:flex items-center gap-1 rounded-lg border border-slate-200 dark:border-slate-800 bg-slate-100/80 dark:bg-slate-900/60 p-0.5 text-xs font-semibold">
              <button
                onClick={() => onSelectVariant("v2.1")}
                className="px-2 py-1 rounded text-slate-700 dark:text-slate-200 hover:bg-white dark:hover:bg-slate-800 transition-colors cursor-pointer"
                title="Switch to v2.1 Focus (Streamlined Cyber Blueprint)"
              >
                v2.1 Focus
              </button>
              <button
                ...
                className="px-2 py-1 rounded text-slate-700 dark:text-slate-200 hover:bg-white dark:hover:bg-slate-800 transition-colors cursor-pointer"
                title="Switch to v2 Blueprint (Full)"
              >
                v2 Cyber
              </button>
            </div>
            ...
            >
              ...
              <div className="pt-2 border-t border-slate-200 dark:border-slate-800 space-y-1.5">
                <button
                  ...
                  className="flex items-center justify-between w-full py-2 px-3 rounded-lg text-xs font-semibold border border-indigo-200 dark:border-indigo-800/60 bg-indigo-50/60 dark:bg-indigo-950/30 text-indigo-800 dark:text-indigo-200 cursor-pointer"
                >
                  <span className="flex items-center gap-2">
                    <Layers className="w-3.5 h-3.5 text-indigo-600 dark:text-indigo-400" />
                    <span>Switch to v2.1 Focus (Streamlined)</span>
                  </span>
                ...
                <button
                  ...
                  className="flex items-center justify-between w-full py-2 px-3 rounded-lg text-xs font-semibold border border-amber-200 dark:border-amber-800/60 bg-amber-50/60 dark:bg-amber-950/30 text-amber-800 dark:text-amber-200 cursor-pointer"
                >
                  <span className="flex items-center gap-2">
                    <Layers className="w-3.5 h-3.5 text-amber-600 dark:text-amber-400" />
                    <span>Switch to v2 Cyber Blueprint (Full)</span>
                  </span>
                  <ChevronRight className="w-3.5 h-3.5 opacity-60" />
                </button>
              </div>
